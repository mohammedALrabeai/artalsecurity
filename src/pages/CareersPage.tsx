...
import { Briefcase, MapPin, Clock, DollarSign, ChevronRight, Users, TrendingUp, Award, ArrowLeft } from 'lucide-react';
...
export function CareersPage() {
  ...
  return (
    <>
      <SEO 
        title={language === 'ar' ? 'الوظائف - أرتال للخدمات الأمنية' : 'Careers - Artal Security Services'}
        description={language === 'ar' 
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white pt-28 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-gray-600 hover:text-[#EFB621] transition-colors mb-8 group"
          >
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-4 mb-4">
                          ...
                          <div className="flex-1">
                            <h3 className="text-2xl mb-2 text-gray-900 group-hover:text-[#EFB621] transition-colors">
                              {position.title}
                            </h3>
